                    ...
                    <div className="nodeHeader">
                        ...
                        <div style={{ width: "100%" }}>
                            ...
                            <div style={{ float: 'right' }}>
                                {['SCRIPT', 'API'].includes(element.key) && <img onClick={openModal} src={Edit} />}&nbsp;<img onClick={deleteNode} src={Cross} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={styles.modalInner} onClick={onClickModalInner}>
                        <div style={styles.modalHeader}>
                            ...
                            <div style={styles.modalHeaderRight}>
                                <div onClick={() => saveUpdatedData(element)} style={styles.modalSaveButton}>Save Changes</div>
